...
#define VEP_MEMSHARED0_SHARED_REGION_SIZE                0x00000400
#define VEP_MEMSHARED0_SHARED_REGION_REMOTE_START        0xB0013400
#define VEP_TILE0_PARTITION1_IDMEM_SIZE                  0x00007C00 /* without shared region */
#define VEP_TILE0_PARTITION1_IDMEM_START                 0x00000000 /* always 0 */
#define VEP_TILE0_PARTITION1_SHARED_REGION_SIZE          0x00000400
#define VEP_TILE0_PARTITION1_SHARED_REGION_LOCAL_START   0x00007C00 /* only for partition_0_1 */
#define VEP_TILE0_PARTITION1_SHARED_REGION_REMOTE_START  0x8000FC00
